...
namespace SS2POS.Controllers
{
    public class ProductController : Controller
    {
        ...
        private string UploadImage(ProductDTO product)
        {
            ...
            {
                string uploadsFolder = Path.Combine(_web.WebRootPath, "Uploads");
                uniqueFileName = product.ProductId.ToString() + "_" + product.Image.FileName;
        ...
        //private IFormFile ImageFile(string path)
        //{
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ProductId,Name,CategoryId,Qty,Price")] Product product)
        {
